...
class SelectVersionViewController: UIViewController {
    ...
    @objc private func openCameraFullNormal() {
        ...
        objCamera.colorBackgroundMain = self.UIColorFromRGB(rgbValue: 0x181d5d, alpha: 1.0)
        
        objCamera.colorLine = self.UIColorFromRGB(rgbValue: 0xD9D9D9, alpha: 1.0)
        
        objCamera.colorBackgroundButton = self.UIColorFromRGB(rgbValue: 0xe85e02, alpha: 1.0)
        
        objCamera.colorEkycTextButton = self.UIColorFromRGB(rgbValue: 0xffffff, alpha: 1.0)
        
        objCamera.colorEkycCaptureBackground = self.UIColorFromRGB(rgbValue: 0x122F41, alpha: 1.0)
        
        objCamera.colorEkycEffect = self.UIColorFromRGB(rgbValue: 0xff5c5c, alpha: 1.0)
        ...
        objCamera.colorEkycUnderBackgound = self.UIColorFromRGB(rgbValue: 0xff7438, alpha: 1.0)
        
        objCamera.colorBackgroundPopup = self.UIColorFromRGB(rgbValue: 0x314490, alpha: 1.0)
        
        objCamera.colorEkycTextPopup = self.UIColorFromRGB(rgbValue: 0xfafdff, alpha: 1.0)

        objCamera.imageTrademark = UIImage(named: "logo", in: Bundle.main, compatibleWith: nil)!
        
        objCamera.sizeLogo = CGSize(width: 20, height: 20);
