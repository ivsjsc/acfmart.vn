              ...
              <table className="min-w-full divide-y divide-neutral-200">
                ...
                <tbody className="bg-white divide-y divide-neutral-200">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-sm">Quy trình 5 bước quét mã bắt buộc trong hành journey logistics: (1) Xuất kho → (2) Pickup → (3) Kiểm định Hub → (4) Giao hàng → (5) Xác nhận bởi Buyer.</td>
                  </tr>
                </tbody>
              </table>
            </div>
