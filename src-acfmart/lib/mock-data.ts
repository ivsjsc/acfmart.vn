export const MOCK_CATEGORIES: MockCategory[] = [
  ...
  { id: "nam-kinh-mat", slug: "nam-kinh-mat", name: "Kính Mắt Nam", icon: "🕶️", productCount: 180 },
  ...
  { id: "pkts-nu-gang-tay", slug: "pkts-nu-gang-tay", name: "Găng tay", icon: "🧤", productCount: 120 },
  ...
  { id: "baltvn-nam-vi-cam-tay", slug: "baltvn-nam-vi-cam-tay", name: "Ví Cầm Tay Nam", icon: "👛", productCount: 140 },
  ...
  { id: "baltvn-nam-bop-vi", slug: "baltvn-nam-bop-vi", name: "Bóp/Ví Nam", icon: "👛", productCount: 320 },
  ...
  { id: "gdn-giay-the-thao", slug: "gdn-giay-the-thao", name: "Giày Thể Thao/ Sneaker", icon: "👟", productCount: 420 },
  { id: "gdn-giay-de-bang", slug: "gdn-giay-de-bang", name: "Giày Đế Bằng", icon: " flats", productCount: 280 },
  { id: "gdn-giay-cao-got", slug: "gdn-giay-cao-got", name: "Giày Cao Gót", icon: "👠", productCount: 320 },
  { id: "gdn-giay-de-xuong", slug: "gdn-giay-de-xuong", name: "Giày Đế Xuồng", icon: " slides", productCount: 210 },
  { id: "gdn-xang-dan-dep", slug: "gdn-xang-dan-dep", name: "Xăng-đan Và Dép", icon: "👡", productCount: 380 },
  ...
  { id: "ttdl-giay-the-thao", slug: "ttdl-giay-the-thao", name: "Giày Thể Thao", icon: "👟", productCount: 380 },
  { id: "ttdl-thoi-trang-the-thao", slug: "ttdl-thoi-trang-the-thao", name: "Thời Trang Thể Thao & Dã Ngoại", icon: "🏃", productCount: 420 },
  { id: "ttdl-phu-kien-the-thao", slug: "ttdl-phu-kien-the-thao", name: "Phụ Kiện Thể Thao & Dã Ngoại", icon: "💪", productCount: 280 },
  ...
  { id: "ttte-giay-dep-be-trai", slug: "ttte-giay-dep-be-trai", name: "Giày dép bé trai", icon: "👟", productCount: 180 },
  { id: "ttte-giay-dep-be-gai", slug: "ttte-giay-dep-be-gai", name: "Giày dép bé gái", icon: "👟", productCount: 220 },
  ...
  { id: "sac-dep-tam-cham-soc-co-the", slug: "sac-dep-tam-cham-soc-co-the", name: "Tắm & chăm sóc cơ thể", icon: "🛁", productCount: 420 },
  ...
  { id: "gdn-giay-the-thao-sneakers", slug: "gdn-giay-the-thao-sneakers", name: "Giày Thể Thao/ Sneakers", icon: "👟", productCount: 320 },
  ...
  { id: "gdn-giay-oxfords-buoc-day", slug: "gdn-giay-oxfords-buoc-day", name: "Giày Oxfords & Giày Buộc Dây", icon: "👞", productCount: 250 },
  { id: "gdn-xang-dan-dep", slug: "gdn-xang-dan-dep", name: "Xăng-đan và Dép", icon: "👡", productCount: 280 },
  ...
  { id: "bhon-do-che-bien-san", slug: "bhon-do-che-bien-san", name: "Đồ chế biến sẵn", icon: "🍲", productCount: 380 },
  { id: "bhon-nhu-yeu-pham", slug: "bhon-nhu-yeu-pham", name: "Nhu yếu phẩm", icon: "🧴", productCount: 520 },
  { id: "bhon-nguyen-lieu-nau-an", slug: "bhon-nguyen-lieu-nau-an", name: "Nguyên liệu nấu ăn", icon: "🌶️", productCount: 420 },
  { id: "bhon-do-lam-banh", slug: "bhon-do-lam-banh", name: "Đồ làm bánh", icon: "🧁", productCount: 280 },
  { id: "bhon-sua-trung", slug: "bhon-sua-trung", name: "Sữa - trứng", icon: "🥛", productCount: 320 },
  { id: "bhon-do-uong", slug: "bhon-do-uong", name: "Đồ uống", icon: "🥤", productCount: 480 },
  { id: "bhon-ngu-coc-mut", slug: "bhon-ngu-coc-mut", name: "Ngũ cốc & mứt", icon: "🌾", productCount: 220 },
  { id: "bhon-cac-loai-banh", slug: "bhon-cac-loai-banh", name: "Các loại bánh", icon: "🥮", productCount: 320 },
  { id: "bhon-do-uong-co-con", slug: "bhon-do-uong-co-con", name: "Đồ uống có cồn", icon: "🍷", productCount: 180 },
  { id: "bhon-bo-qua-tang", slug: "bhon-bo-qua-tang", name: "Bộ quà tặng", icon: "🎁", productCount: 280 },
  { id: "bhon-thuc-pham-tuoi-song", slug: "bhon-thuc-pham-tuoi-song", name: "Thực phẩm tươi sống và thực phẩm đông lạnh", icon: "🥩", productCount: 380 },
  { id: "bhon-khac", slug: "bhon-khac", name: "Khác", icon: "misc", productCount: 250 },

  // Danh mục: Đồ Chơi
  { id: "do-choi-so-thich-suu-tam", slug: "do-choi-so-thich-suu-tam", name: "Sở thích & Sưu tầm", icon: "🏺", productCount: 180 },
  { id: "do-choi-giai-tri", slug: "do-choi-giai-tri", name: "Đồ chơi giải trí", icon: "🎲", productCount: 280 },
  { id: "do-choi-giao-duc", slug: "do-choi-giao-duc", name: "Đồ chơi giáo dục", icon: "🎓", productCount: 220 },
  { id: "do-choi-cho-tre-so-sinh", slug: "do-choi-cho-tre-so-sinh", name: "Đồ chơi cho trẻ sơ sinh & trẻ nhỏ", icon: "🧸", productCount: 320 },
  { id: "do-choi-van-dong-ngoai-troi", slug: "do-choi-van-dong-ngoai-troi", name: "Đồ chơi vận động & ngoài trời", icon: "⚽", productCount: 280 },
  { id: "do-choi-bup-be-noi-bong", slug: "do-choi-bup-be-noi-bong", name: "Búp bê & Đồ chơi nhồi bông", icon: "🧸", productCount: 250 },

  // Danh mục: Mẹ & Bé
  { id: "mebe-do-dung-du-lich", slug: "mebe-do-dung-du-lich", name: "Đồ dùng du lịch cho bé", icon: "🧳", productCount: 180 },
  { id: "mebe-do-dung-an-dam", slug: "mebe-do-dung-an-dam", name: "Đồ dùng ăn dặm cho bé", icon: "🍼", productCount: 280 },
  { id: "mebe-phu-kien-cho-me", slug: "mebe-phu-kien-cho-me", name: "Phụ kiện cho mẹ", icon: "👩", productCount: 220 },
  { id: "mebe-cham-soc-suc-khoe-me", slug: "mebe-cham-soc-suc-khoe-me", name: "Chăm sóc sức khỏe mẹ", icon: "🏥", productCount: 320 },
  { id: "mebe-do-dung-phong-tam", slug: "mebe-do-dung-phong-tam", name: "Đồ dùng phòng tắm & Chăm sóc cơ thể bé", icon: "🛁", productCount: 380 },
  { id: "mebe-do-dung-phong-ngu", slug: "mebe-do-dung-phong-ngu", name: "Đồ dùng phòng ngủ cho bé", icon: "🛏️", productCount: 280 },
  { id: "mebe-an-toan-cho-be", slug: "mebe-an-toan-cho-be", name: "An toàn cho bé", icon: "🔒", productCount: 220 },
  { id: "mebe-thuc-pham-cho-be", slug: "mebe-thuc-pham-cho-be", name: "Thực phẩm cho bé", icon: "🍎", productCount: 420 },
  { id: "mebe-cham-soc-suc-khoe-be", slug: "mebe-cham-soc-suc-khoe-be", name: "Chăm sóc sức khỏe bé", icon: "🏥", productCount: 380 },
  { id: "mebe-ta-bo-em-be", slug: "mebe-ta-bo-em-be", name: "Tã & bô em bé", icon: " diapers", productCount: 520 },
  { id: "mebe-do-choi", slug: "mebe-do-choi", name: "Đồ chơi", icon: "🧸", productCount: 380 },
  { id: "mebe-bo-goi-qua-tang", slug: "mebe-bo-goi-qua-tang", name: "Bộ & Gói quà tặng", icon: "🎁", productCount: 280 },
  { id: "mebe-khac", slug: "mebe-khac", name: "Khác", icon: "misc", productCount: 220 },
  { id: "mebe-sua-cong-thuc-tren-24", slug: "mebe-sua-cong-thuc-tren-24", name: "Sữa công thức trên 24 tháng", icon: "🥛", productCount: 280 },
  { id: "mebe-sua-cong-thuc-0-24", slug: "mebe-sua-cong-thuc-0-24", name: "Sữa công thức 0-24 tháng tuổi", icon: "🍼", productCount: 320 },

  // Danh mục: Máy Ảnh & Máy Quay Phim
  { id: "may-anh-may-quay", slug: "may-anh-may-quay", name: "Máy ảnh - Máy quay phim", icon: "📷", productCount: 280 },
  { id: "may-anh-camera-giam-sat", slug: "may-anh-camera-giam-sat", name: "Camera giám sát & Camera hệ thống", icon: "📹", productCount: 220 },
  { id: "may-anh-the-nho", slug: "may-anh-the-nho", name: "Thẻ nhớ", icon: "💾", productCount: 320 },
  { id: "may-anh-ong-kinh", slug: "may-anh-ong-kinh", name: "Ống kính", icon: "🔍", productCount: 280 },
  { id: "may-anh-phu-kien", slug: "may-anh-phu-kien", name: "Phụ kiện máy ảnh", icon: "📸", productCount: 380 },
  { id: "may-anh-may-bay-camera", slug: "may-anh-may-bay-camera", name: "Máy bay camera & Phụ kiện", icon: "🚁", productCount: 220 },

  // Danh mục: Túi Ví Nữ
  { id: "tvn-balô-nu", slug: "tvn-balô-nu", name: "Ba Lô Nữ", icon: "🎒", productCount: 280 },
  { id: "tvn-cap-laptop", slug: "tvn-cap-laptop", name: "Cặp Laptop", icon: "💼", productCount: 180 },
  { id: "tvn-vi-du-tiec-vi-cam-tay", slug: "tvn-vi-du-tiec-vi-cam-tay", name: "Ví Dự Tiệc & Ví Cầm Tay", icon: "👛", productCount: 220 },
  { id: "tvn-tui-deo-hong-nguc", slug: "tvn-tui-deo-hong-nguc", name: "Túi Đeo Hông & Túi Đeo Ngực", icon: "👜", productCount: 180 },
  { id: "tvn-tui-tote", slug: "tvn-tui-tote", name: "Túi Tote", icon: "🛍️", productCount: 280 },
  { id: "tvn-tui-quai-xach", slug: "tvn-tui-quai-xach", name: "Túi Quai Xách", icon: "👜", productCount: 320 },
  { id: "tvn-tui-deo-cheo-deo-vai", slug: "tvn-tui-deo-cheo-deo-vai", name: "Túi Đeo Chéo & Túi Đeo Vai", icon: "🎒", productCount: 420 },
  { id: "tvn-vi-bop-nu", slug: "tvn-vi-bop-nu", name: "Ví/Bóp Nữ", icon: " purse", productCount: 380 },
  { id: "tvn-phu-kien-tui", slug: "tvn-phu-kien-tui", name: "Phụ Kiện Túi", icon: "👜", productCount: 220 },
  { id: "tvn-khac", slug: "tvn-khac", name: "Khác", icon: "misc", productCount: 280 },

  // Danh mục: Ô Tô & Xe Máy & Xe Đạp
  { id: "otoxe-dien", slug: "otoxe-dien", name: "Xe đạp, xe điện", icon: "🚲", productCount: 280 },
  { id: "otoxe-moto-xe-may", slug: "otoxe-moto-xe-may", name: "Mô tô, xe máy", icon: "🏍️", productCount: 380 },
  { id: "otoxe-o-to", slug: "otoxe-o-to", name: "Xe Ô tô", icon: "🚗", productCount: 580 },
  { id: "otoxe-mu-bao-hiem", slug: "otoxe-mu-bao-hiem", name: "Mũ bảo hiểm", icon: "helmet", productCount: 320 },
  { id: "otoxe-phu-kien-xe-may", slug: "otoxe-phu-kien-xe-may", name: "Phụ kiện xe máy", icon: "🔧", productCount: 420 },
  { id: "otoxe-phu-kien-xe-dap", slug: "otoxe-phu-kien-xe-dap", name: "Phụ kiện xe đạp", icon: "🚲", productCount: 280 },
  { id: "otoxe-phu-kien-ben-trong", slug: "otoxe-phu-kien-ben-trong", name: "Phụ kiện bên trong ô tô", icon: "🚗", productCount: 320 },
  { id: "otoxe-dau-nhot-dau-nhon", slug: "otoxe-dau-nhot-dau-nhon", name: "Dầu nhớt & dầu nhờn", icon: "oil", productCount: 280 },
  { id: "otoxe-phu-tung-o-to", slug: "otoxe-phu-tung-o-to", name: "Phụ tùng ô tô", icon: "🔧", productCount: 480 },
  { id: "otoxe-phu-tung-xe-may", slug: "otoxe-phu-tung-xe-may", name: "Phụ tùng xe máy", icon: "🔧", productCount: 380 },
  { id: "otoxe-phu-kien-ben-ngoai", slug: "otoxe-phu-kien-ben-ngoai", name: "Phụ kiện bên ngoài ô tô", icon: "🚗", productCount: 320 },
  { id: "otoxe-cham-soc-o-to", slug: "otoxe-cham-soc-o-to", name: "Chăm sóc ô tô", icon: "🚗", productCount: 280 },
  { id: "otoxe-dich-vu-cho-xe", slug: "otoxe-dich-vu-cho-xe", name: "Dịch vụ cho xe", icon: "service", productCount: 220 },

  // Danh mục: Giặt Giũ & Chăm Sóc Nhà Cửa
  { id: "ggcsn-giat-giu-cham-soc", slug: "ggcsn-giat-giu-cham-soc", name: "Giặt giũ & Chăm sóc nhà cửa", icon: "🧺", productCount: 380 },
  { id: "ggcsn-giay-ve-sinh-khan-giay", slug: "ggcsn-giay-ve-sinh-khan-giay", name: "Giấy vệ sinh, khăn giấy", icon: "🧻", productCount: 280 },
  { id: "ggcsn-ve-sinh-nha-cua", slug: "ggcsn-ve-sinh-nha-cua", name: "Vệ sinh nhà cửa", icon: "🧹", productCount: 320 },
  { id: "ggcsn-ve-sinh-bat-dia", slug: "ggcsn-ve-sinh-bat-dia", name: "Vệ sinh bát đĩa", icon: "🍽️", productCount: 220 },
  { id: "ggcsn-dung-cu-ve-sinh", slug: "ggcsn-dung-cu-ve-sinh", name: "Dụng cụ vệ sinh", icon: " mop", productCount: 280 },
  { id: "ggcsn-chat-khu-mui-lam-thom", slug: "ggcsn-chat-khu-mui-lam-thom", name: "Chất khử mùi, làm thơm", icon: "💨", productCount: 320 },
  { id: "ggcsn-thuoc-diet-con-trung", slug: "ggcsn-thuoc-diet-con-trung", name: "Thuốc diệt côn trùng", icon: "🕷️", productCount: 180 },
  { id: "ggcsn-tui-mang-boc-thuc-pham", slug: "ggcsn-tui-mang-boc-thuc-pham", name: "Túi, màng bọc thực phẩm", icon: "📦", productCount: 220 },
  { id: "ggcsn-bao-bi-tui-dung-rac", slug: "ggcsn-bao-bi-tui-dung-rac", name: "Bao bì, túi đựng rác", icon: "🗑️", productCount: 280 },
]